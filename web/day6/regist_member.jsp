...
%>
<form action="process_regist.jsp" method="get" enctype="application/x-www-form-urlencoded">

    <table>
        <tr>
            <td>아이디</td>
            <td><input type="text" name="id" id="userid" value="<%=memberVO.getId()%>">
            <input type="text" name="" id="message" disabled="disabled"></td>
            <td><button onclick="return id_check_with_ajax(0)">아이디 체크</button> </td>
        ...
        <tr>
            <td>우편번호</td>
            <td><input type="text" name="zip" size="10" id="zip" value="<%=memberVO.getZip()%>">
